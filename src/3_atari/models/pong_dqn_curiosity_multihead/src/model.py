...
class Model(torch.nn.Module):
    ...
    def __init__(self, input_shape, outputs_count):
        ...
        fc_inputs_count = fc_input_height*fc_input_width*64
    ...
    def load(self, path):
        ...
        self.model_features.load_state_dict(torch.load(path + "trained/model_DQN_features.pt"))
        self.model_value.load_state_dict(torch.load(path + "trained/model_DQN_value.pt"))
        self.model_advantage.load_state_dict(torch.load(path + "trained/model_DQN_advantage.pt"))
