...
from .CuriosityModuleParalel import *


class AgentDDPGCuriosityParalel():
    def __init__(self, env, ModelCritic, ModelActor, ModelCuriosity, Config):
        ...
        self.curiosity_module = CuriosityModuleParalel(ModelCuriosity, self.state_shape, self.actions_count, config.curiosity_paralel_count, config.curiosity_learning_rate, config.curiosity_buffer_size, True)
