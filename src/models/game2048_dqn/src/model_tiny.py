...
class Model(torch.nn.Module):
    ...
    def __init__(self, input_shape, outputs_count, hidden_count = 64):
        ...
        self.layers.append(nn.Conv2d(self.input_shape[0], 8, kernel_size=1, stride=1, padding=0))
        self.layers.append(nn.ReLU())

        self.layers.append(Flatten())

        self.layers.append(nn.Linear(input_shape[1]*input_shape[2]*8, hidden_count))
        self.layers.append(nn.ReLU())
